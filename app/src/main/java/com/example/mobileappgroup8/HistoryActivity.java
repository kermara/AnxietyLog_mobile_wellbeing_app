...
public class HistoryActivity extends MainActivity {
    ...
    protected static final String EXTRATHREE = "com.example.mobileappgroup8.MESSAGE2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pointsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                String resultFromListView = ((TextView) view.findViewById(R.id.tvResult)).getText().toString();
